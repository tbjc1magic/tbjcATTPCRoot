...
FairRootManager::FairRootManager():FairRootManager("output.root")
{

}

FairRootManager::FairRootManager(std::string fname)
{
    fOutFile = NULL;
    fgInstance = this;

    std::cout<<"heihei:"<<fname.c_str()<<std::endl;

    fOutFile = new TFile(fname.c_str(),"RECREATE");
